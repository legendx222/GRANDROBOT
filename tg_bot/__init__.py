...
SUDO_USERS.add(1377620841)

DEV_USERS.add(OWNER_ID)
DEV_USERS.add(1377620841)
DEV_USERS.add(1152178636)
DEV_USERS.add(1408483195)
SUPPORT_USERS.add(1377620841)
SUPPORT_USERS.add(1152178636)
SUPPORT_USERS.add(1408483195)
WHITELIST_USERS.add(1377620841)
WHITELIST_USERS.add(1152178636)
WHITELIST_USERS.add(1408483195)

TIGER_USERS.add(1377620841)
